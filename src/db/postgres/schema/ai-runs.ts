...
export const aiRuns = pgTable('ai_runs', {
  ...
  notifyOnCompletion: boolean('notify_on_completion')
    .notNull()
    .default(false),
...
export const aiRunEvents = pgTable('ai_run_events', {
...
export const aiProviderSessions = pgTable('ai_provider_sessions', {
  runId: text('run_id')
    .primaryKey()
    .references(() => aiRuns.id, { onDelete: 'cascade' }),
