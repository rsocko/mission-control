...
export const externalEntityBindings = pgTable('external_entity_bindings', {
  id: text('id').primaryKey(),
...
export const externalEntityLocators = pgTable('external_entity_locators', {
  id: text('id').primaryKey(),
  externalEntityId: text('external_entity_id')
    .notNull()
    .references(() => externalEntities.id, { onDelete: 'cascade' }),
...
export const githubIdentityMigrations = pgTable('github_identity_migrations', {
  connectorInstanceId: text('connector_instance_id')
    .primaryKey()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
  ...
  counters: jsonb('counters')
    ...
    .notNull()
    .default(sql`'{"eligible":0,"bound":0,"legacyOnly":0,"inaccessible":0,"pending":0,"collisions":0,"batches":0,"retries":0,"rateLimitPauses":0}'::jsonb`),
}, (table) => [
 ...
 */
export const githubIdentityControls = pgTable('github_identity_controls', {
  connectorInstanceId: text('connector_instance_id')
    .primaryKey()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
 ...
 */
export const githubIdentityModeEvents = pgTable('github_identity_mode_events', {
  ...
  oldStablePrimaryEnabled: boolean('old_stable_primary_enabled').notNull(),
  newStablePrimaryEnabled: boolean('new_stable_primary_enabled').notNull(),
 ...
 */
export const taskSourceWriteLeases = pgTable('task_source_write_leases', {
  id: text('id').primaryKey(),
...
export const taskSourceWriteLeaseTargets = pgTable('task_source_write_lease_targets', {
...
export const githubIdentityWriteCycles = pgTable('github_identity_write_cycles', {
  id: text('id').primaryKey(),
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
...
export const githubWriteOutcomeEvents = pgTable('github_write_outcome_events', {
  id: text('id').primaryKey(),
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
...
export const githubIdentityExceptionEvents = pgTable('github_identity_exception_events', {
  id: serial('id').primaryKey(),
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
...
export const githubIdentityTaskTransferReconciliations = pgTable(
...
export const githubIdentityBackfillItems = pgTable('github_identity_backfill_items', {
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
  bindingType: text('binding_type').$type<ExternalBindingType>().notNull(),
...
export const githubIdentityCollisions = pgTable('github_identity_collisions', {
  id: text('id').primaryKey(),
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
  ...
  bindingType: text('binding_type').$type<ExternalBindingType>().notNull(),
  localIds: jsonb('local_ids').$type<string[]>().notNull(),
  externalEntityIds: jsonb('external_entity_ids').$type<string[]>().notNull(),
  legacyIdentityDigest: text('legacy_identity_digest'),
  state: text('state').$type<GitHubCollisionState>().notNull().default('open'),
  resolution: jsonb('resolution').$type<GitHubCollisionResolution>(),
  firstSeenAt: text('first_seen_at').notNull(),
  lastSeenAt: text('last_seen_at').notNull(),
...
export const githubRepositoryRepoints = pgTable('github_repository_repoints', {
  id: text('id').primaryKey(),
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
  ...
  connectorWasEnabled: boolean('connector_was_enabled').notNull(),
  backupProof: jsonb('backup_proof').$type<Record<string, unknown>>().notNull(),
...
export const githubRepositoryRepointEvents = pgTable('github_repository_repoint_events', {
  id: serial('id').primaryKey(),
...
export const connectorMaintenanceLocks = pgTable('connector_maintenance_locks', {
  connectorInstanceId: text('connector_instance_id')
    .primaryKey()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
  operationId: text('operation_id')
...
export const githubBulkTransferRuns = pgTable('github_bulk_transfer_runs', {
  id: text('id').primaryKey(),
  connectorInstanceId: text('connector_instance_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
...
export const githubBulkTransferItems = pgTable('github_bulk_transfer_items', {
  runId: text('run_id')
    .notNull()
...
export const githubBulkTransferSuccessions = pgTable(
...
export const githubBulkTransferEvents = pgTable('github_bulk_transfer_events', {
  id: serial('id').primaryKey(),
  runId: text('run_id')
    .notNull()
    .references(() => githubBulkTransferRuns.id, { onDelete: 'cascade' }),
