...
export const financeTransactions = pgTable('finance_transactions', {
  ...
  attributionRetryable: boolean('attribution_retryable').notNull().default(false),
  ...
  tagReferences: jsonb('tag_references')
    .$type<string[]>()
    .notNull()
    .default(sql`'[]'::jsonb`),
...
export const financeConnectionOutages = pgTable('finance_connection_outages', {
  connectorId: text('connector_id').primaryKey(),
...
export const financeInsightTransactionBackfillPlans = pgTable(
...
export const financeInsightTransactionWindowProofs = pgTable(
...
export const financeDatasetSyncState = pgTable('finance_dataset_sync_state', {
  connectorId: text('connector_id').notNull(),
...
export const financeAccounts = pgTable('finance_accounts', {
  ...
  sourceIsActive: boolean('source_is_active').notNull().default(true),
...
export const financeCategoryGroups = pgTable('finance_category_groups', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
...
export const financeTags = pgTable('finance_tags', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
...
export const financeRecurringObligations = pgTable('finance_recurring_obligations', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
...
export const financeBudgetSnapshots = pgTable('finance_budget_snapshots', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
  generationId: text('generation_id').notNull(),
...
export const financeMutationAudit = pgTable('finance_mutation_audit', {
  id: text('id').primaryKey(),
  idempotencyKey: text('idempotency_key').notNull(),
  connectorId: text('connector_id').notNull(),
...
export const houstonFinanceActionAudit = pgTable('houston_finance_action_audit', {
  id: text('id').primaryKey(),
...
export const financeAttributionExceptions = pgTable('finance_attribution_exceptions', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
  transactionId: text('transaction_id').notNull(),
...
export const financeAttributionAudit = pgTable('finance_attribution_audit', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
  transactionId: text('transaction_id').notNull(),
...
export const financeAttentionRepairAudit = pgTable('finance_attention_repair_audit', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
...
export const financeInsightPublicationState = pgTable('finance_insight_publication_state', {
  connectorId: text('connector_id').primaryKey(),
...
export const financeInsightTransactionProjectionState = pgTable(
...
export const financeInsightTransactionProjectionWindows = pgTable(
...
export const financeInsightTransactionProjectionFacts = pgTable(
...
export const financeInsightPublications = pgTable('finance_insight_publications', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id').notNull(),
  ...
  currency: text('currency').notNull(),
  bridgeContractVersion: text('bridge_contract_version').notNull(),
  capturedConstituents: jsonb('captured_constituents').notNull(),
  manifest: jsonb('manifest').notNull(),
  manifestDigest: text('manifest_digest').notNull(),
  createRequest: jsonb('create_request').notNull(),
  idempotencyKey: text('idempotency_key').notNull(),
  alertCapable: boolean('alert_capable').notNull().default(false),
...
export const financeInsightPublicationFacts = pgTable('finance_insight_publication_facts', {
...
export const financeInsightPublicationDelivery = pgTable('finance_insight_publication_delivery', {
  publicationId: text('publication_id')
    .primaryKey()
    .references(() => financeInsightPublications.id, { onDelete: 'cascade' }),
  connectorId: text('connector_id').notNull(),
  ...
  lastSuccessfulAt: text('last_successful_at'),
  lastErrorCode: text('last_error_code'),
  lastErrorRetryable: boolean('last_error_retryable').notNull().default(false),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
}, (table) => [
...
export const financeInsightOccurrenceCacheState = pgTable('finance_insight_occurrence_cache_state', {
  connectorId: text('connector_id').primaryKey(),
...
export const financeInsightOccurrences = pgTable('finance_insight_occurrences', {
  connectorId: text('connector_id').notNull(),
  ...
  freshnessState: text('freshness_state')
    ...
    .notNull(),
  sourceAsOf: text('source_as_of'),
  targetDescriptors: jsonb('target_descriptors').notNull(),
...
export const financeInsightCutovers = pgTable('finance_insight_cutovers', {
  connectorId: text('connector_id').primaryKey(),
...
export const financeInsightCutoverAudit = pgTable('finance_insight_cutover_audit', {
  id: text('id').primaryKey(),
  connectorId: text('connector_id')
    .notNull()
    .references(() => connectorConfigs.id, { onDelete: 'cascade' }),
  ...
  blockerCodes: jsonb('blocker_codes').$type<string[]>().notNull().default(sql`'[]'::jsonb`),
  legacyExpiredCount: integer('legacy_expired_count').notNull().default(0),
  importedCount: integer('imported_count').notNull().default(0),
...
export const kidCardRules = pgTable('kid_card_rules', {
  id: text('id').primaryKey(),
  kidId: text('kid_id').notNull(),
...
export const kidMerchantRules = pgTable('kid_merchant_rules', {
  id: text('id').primaryKey(),
  kidId: text('kid_id').notNull(),
