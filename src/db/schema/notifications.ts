...
export const notificationActions = sqliteTable('notification_actions', {
  id: text('id').primaryKey(),
  notificationId: text('notification_id').notNull(),
  ...
  opensExternal: integer('opens_external', { mode: 'boolean' }).notNull().default(false),
...
export const notificationSavedViews = sqliteTable('notification_saved_views', {
  id: text('id').primaryKey(),
