...
function seedDatabaseContents(db: Database.Database): void {
    ...
    const alertData = [
      ...
      { id: 'a-8', sourceId: 'gh-notif-6', connectorType: 'github-issues', connectorInstanceId: 'github-1', title: 'Dependabot: 2 security vulnerabilities', body: 'acme/project-alpha has 2 moderate severity vulnerabilities in dependencies.', severity: 'heads_up', category: 'security', isRead: 1, isActionable: 1, actionUrl: 'https://github.com/acme/project-alpha/security/dependabot', receivedAt: hoursAgo(8) },
      { id: 'a-9', sourceId: 'gh-notif-7', connectorType: 'github-issues', connectorInstanceId: 'github-2', title: 'Deploy succeeded: api-gateway v2.4.1', body: 'Production deployment completed in 3m 42s. All health checks passing.', severity: 'digest', category: 'deploy', isRead: 1, isActionable: 0, actionUrl: null, receivedAt: hoursAgo(12) },
      ...
      { id: 'a-11', sourceId: 'gh-notif-8', connectorType: 'github-issues', connectorInstanceId: 'github-1', title: 'Issue closed: home-assistant-config#8', body: 'Presence detection is working. Closed by @contributor.', severity: 'digest', category: 'issue-closed', isRead: 1, isActionable: 0, actionUrl: null, receivedAt: daysAgo(2) },
    ...
    const notificationData = [
      { id: 'notif-1', sourceId: 'gh-pr-approved-38', connectorType: 'github-issues', connectorInstanceId: 'github-1', title: 'PR #38 approved by @teammate', body: 'Your pull request "Add webhook support" has been approved and is ready to merge.', level: 'success', levelRank: 2, category: 'pr-review', state: 'unread', isActionable: 1, receivedAt: hoursAgo(1), sortAt: hoursAgo(1), groupKey: 'pr-38', relatedTaskId: 't-13', navigationTarget: '/projects/proj-mission-control' },
      { id: 'notif-2', sourceId: 'gh-ci-fail-142', connectorType: 'github-issues', connectorInstanceId: 'github-1', title: 'CI failed on main branch', body: 'Build #142 failed: test suite timeout in auth module. 3 tests timed out after 30s.', level: 'urgent', levelRank: 1, category: 'ci-failure', state: 'unread', isActionable: 1, receivedAt: hoursAgo(2), sortAt: hoursAgo(2), groupKey: null, relatedProjectId: 'proj-mission-control', navigationTarget: null },
      { id: 'notif-3', sourceId: 'gh-mention-45', connectorType: 'github-issues', connectorInstanceId: 'github-1', title: 'Mentioned in issue #45', body: '@contributor can you look at the network timeout issue? Seems related to the retry logic.', level: 'fyi', levelRank: 3, category: 'mention', state: 'unread', isActionable: 1, receivedAt: hoursAgo(3), sortAt: hoursAgo(3), groupKey: null, relatedTaskId: null, navigationTarget: null },
