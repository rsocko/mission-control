...
export function registerFakeTaskCorePersistence(
  ...
  registerTaskCorePersistence({
    ...
    priorityEntities: {
      ...
      createPriorityEntity: async (input: PriorityEntityCreate) => ({
        ...input,
      ...
      updatePriorityEntities: async () => undefined,
      deletePriorityEntityAndRerank: async () => undefined,
      listPriorityEntityOptions: async () => ({ projects: [], tags: [], sources: [] }),
      listPrioritySyncLog: async () => [],
